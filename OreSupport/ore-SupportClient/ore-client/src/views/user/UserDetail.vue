                          ...
                          <v-row class="form-group">
                            <v-col cols="3">
                              <div class="user-photo">
                                <img src="../../assets/img/tmp/hebi.png" />
                              </div>
                            </v-col>
                            <v-col cols="6" class="pa-5">
                              <div><h3>くろちゃん</h3></div>
                              <hr />
                              <div>男性 / 50代 / ラッパー / 東京都在住</div>
                              <hr />
                              <div>
                                ラップを始めて１０年以上立ちました。<br />最近、記憶力が落ちている気がします。。。
                              </div>
                            </v-col>
                            <v-col>
                              <div>
                              ...
                              <div class="posts">
                                <div>
                                  <div class="post-image">
                                    <img
                                      src="../../assets/img/tmp/1963252_s.jpg"
                                      alt="A Clockwork Origin"
                                    />
                                    <a class="read-more" href="blog_detail.html"
                                      >View</a
                                    >
                                  </div>
                                  <!-- /.post-image -->
                                  ...
                                  <div class="post-content">
                                    <h2>
                                      <a href="blog-detail.html">タイトル</a>
                                    </h2>
                                    <p id="content">
                                      コンテント
                                    </p>
