  ...
  <div>
    ...
    <v-hover v-slot="{ hover }">                                                                                      
      <v-btn
        ...
        :class="{ 'on-hover': hover }"
        tile
        style="width: 100%; height: 60px; background-color: #90EE90; font-size: 20px;"
        @click="moreCheck"
      > 
        <strong>もっと見る</strong>
        <v-icon color="black" size="35">mdi-dots-horizontal-circle-outline</v-icon>
      </v-btn>
    </v-hover>
  </div>
</template>
